...
class NoticeRepositoryTest {
    ...
    void save() {
        Notice notice1 = new Notice( NoticeType.SYSTEM, "title1", "content1");
        Notice notice2 = new Notice( NoticeType.GENERAL, "title2", "content2");
        Notice notice3 = new Notice( NoticeType.SYSTEM, "title3", "content3");
