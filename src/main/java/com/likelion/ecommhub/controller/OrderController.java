...
public class OrderController {
    ...
    public String orderList(
        @PathVariable(name = "page") Optional<Integer> page,/* Principal principal, */Member member,
        Model model) {

        Pageable pageable = PageRequest.of(page.isPresent() ? page.get() : 0, 4);

        Page<OrderListDto> orderListDtos = orderService.getOrderList(/*principal.getName(),*/
